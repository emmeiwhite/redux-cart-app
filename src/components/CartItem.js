...
const mapDispatchToProps = (dispatch, ownProps) => {
  const { id, price, amount } = ownProps;
  return {
    remove: () => dispatch({ type: REMOVE, payload: { id, price } }),
    increase: () =>
      dispatch({ type: INCREASE, payload: { id, price, amount } }),
    decrease: () =>
      dispatch({ type: DECREASE, payload: { id, price, amount } }),
  };
};
